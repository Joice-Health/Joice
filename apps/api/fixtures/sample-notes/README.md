...
see `docs/rag/03-ingestion.md`.

(This README has no `.md`-worthy headings on purpose beyond this one — the
ingest script picks it up too, which is harmless: it just becomes one more
retrievable chunk that says the fixtures are fake.)
